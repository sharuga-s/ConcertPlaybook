...
############################## RETRIEVE USERS TOP TRACKS FROM PAST 6 MONTHS ##############################
...
# Step 4: Get user's top tracks using the access token
def user_top_tracks(access_token):
    # Endpoint to fetch recently played tracks
...
def redirect_page():
    ...
    print(heard_artist_tracks(result["top_tracks"]))
